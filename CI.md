...
Use strict up-to-date required `ci / required` from GitHub Actions, enforced
administrators, zero required reviews and no force-push/deletion bypass on the
default branch. Automerge remains off until the policy and settings are verified.
